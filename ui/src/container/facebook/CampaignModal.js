                                ...
                                <div className="create-campaign-modal">                          
                                    <nav>
                                        <div className="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                                            ...
                                            <a className="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" title={content.ad_account==null ? 'Please select ad account': ''} href={content.ad_account==null ? 'tooltip': '#targeting'} role="tab" aria-controls="targeting" aria-selected="false">Audience Targeting</a>
                                            <a className="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" title={content.ad_account==null ? 'Please select ad account': ''} href={content.ad_account==null ? 'tooltip': '#budgetnschedule'} role="tab" aria-controls="budgetnschedule" aria-selected="false">Budget and Schedule</a>
                                        </div>
                                    </nav>
                                </div>
